...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void almostAllAttendeesConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void allAttendeedConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. Also consider the optional attendee.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void barelyEnoughRoom() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting and ignore the optional attendee.
    //
    // Events  : |--A--|     |----A----|
    //                   |-B-|
    // Day     : |---------------------|
  ...
  public void noMandatoryAttendees() {
      // Have only optional attendees with several gaps in their schedules.
      // Events  :     |-A-|   |-B-|   
      // Day     : |--------------------|
      // Options : |---|   |---|    |---|
  ...
  @Test
  public void noMandatoryAttendeesOrGaps() {
